...
/**
 * holds an attribute name, there's no specific checks , basically it's a string
 *
...
public class GENERICattributename implements XMLElement {
    ...
    /**
     * throws an exception if {@link #name} = null or has length 0
    ...
    /**
     * @return {@link TagAndAttributeNames#GENERICattributenameTag}
